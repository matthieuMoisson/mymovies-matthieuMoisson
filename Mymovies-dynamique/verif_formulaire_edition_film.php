...
<?php 
	...
	if(isset($_FILES['fichier_photo']) AND $_FILES['fichier_photo']['error']==0){
		...
		//Constructeur si c'est une attaque
		...
		$bdd->exec("UPDATE movie SET mov_title='$title', mov_year='$date', mov_description_long='$l_desc', mov_description_short='$s_desc', mov_director='$dir' where mov_id='$id'");
	}
